...
void Greed::generate_miniatures()
{
	...
	SceneTransform *small_terrain_translate = new SceneTransform(scene, glm::translate(glm::mat4(1.f), glm::vec3(4.f, HEIGHT_MAP_MAX-2.f, -2.f)));
	...
	float SMALL_FOREST_RADIUS = 0.25f;
	for (int i = 0; i < 6; ++i)
	{
